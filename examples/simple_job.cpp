...
int main()
{
    ...
    job.addTask(scheduler::core::Task(1, "load data", [] {
        std::cout << "Task 1: load data\n";
    }));
    job.addTask(scheduler::core::Task(2, "process data", [] {
        std::cout << "Task 2: process data\n";
    }));
    job.addTask(scheduler::core::Task(3, "write output", [] {
        std::cout << "Task 3: write output\n";
    }));
